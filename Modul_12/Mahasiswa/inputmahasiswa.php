...
<div class="wrapper">
    <div class="card" style="max-width:520px;margin:0 auto;">
        ...
        <div class="oop-info">Menggunakan <strong>MahasiswaModel::create()</strong> dengan Prepared Statement.</div>
        <form action="proses_inputmahasiswa.php" method="post">
            <div class="form-group">
                <label for="npm">NPM</label>
                <input type="number" name="npm" id="npm" placeholder="Contoh: 2021001" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="alamat" id="alamat" placeholder="Contoh: Jl. Merdeka No.1" required>
            </div>
            <div class="form-group">
                <label for="noHP">No HP</label>
                <input type="text" name="noHP" id="noHP" placeholder="Contoh: 082111222333" required>
            </div>
